# 
# For reading in Temperature climate model data that has been statistically downscaled to 1/8 degree (~12km)
...
flag_obs = 1  
source(c(paste(sep="",workdirUS,"\\CommonFunctions\\get_12km_grid_boundary.R")))
...
temp<-"Tmax"
source(c(paste(sep="",workdirUS,"\\CommonFunctions\\readprecip_obs_12km.R")))
...
temp<-"Tmax"
source(c(paste(sep="",workdirUS,"\\CommonFunctions\\readprecip_12km.R")))
