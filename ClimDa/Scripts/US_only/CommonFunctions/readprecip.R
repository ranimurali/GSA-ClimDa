...
if (Modell[i]="gfdl-esm2g") {
 ...
 num_file_bs=10
 pr_yr_s<-c("19560101","19610101","19660101","19710101","19760101","19810101","19860101","19910101","19960101","20010101")
 pr_yr_f<-c("19601231","19651231","19701231","19751231","19801231","19851231","19901231","19951231","20001231","20051231")}
...
if (Modell[i]="gfdl-esm2m") {
 ...
 pr_yr_f<-c("20101231","20151231","20201231","20251231","20301231","20351231","20401231","20451231")
 num_file_bs=6
 pr_yr_s<-c("19760101","19810101","19860101","19910101","19960101","20010101")
 pr_yr_f<-c("19801231","19851231","19901231","19951231","20001231","20051231")}
...
ifelse(tag>0,num_file<-num_file_pr,num_file<-num_file_bs)
 ...
 if (tag == 1) {
  fil_dir<-c(paste(sep="",workdirUS,"\\US\\",Scen_l,"\\",Modell[i],"\\pr"))}
 if (tag == 0) {
  fil_dir<-c(paste(sep="",workdirUS,"\\US\\HistMod\\",Modell[i],"\\pr"))}
